...
<?php if ($RID2['jumPesan'] != NULL && $RID2['jumPesan'] != 0) {echo '<span class="badge badge-success">'.$RID2['jumPesan'].'</span>';}else{echo '<span class="badge badge-danger">Tiada rekod</span>';}?>
