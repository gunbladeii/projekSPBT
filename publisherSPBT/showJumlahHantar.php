...
<?php if ($RID2['jumHantar'] != NULL && $RID2['jumHantar'] != 0) {echo '<span class="badge badge-success">'.$RID2['jumHantar'].'</span>';}else{echo '<span class="badge badge-danger">Tiada rekod</span>';}?>
