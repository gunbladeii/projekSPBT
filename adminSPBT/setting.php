...
if (isset($_POST["revenue2"])) {
 $mysqli->query("INSERT INTO revenue (date, month, year, totalRevenue) VALUES ('$date', '$month', '$year', '$revenue')");
                ...
                <form action="setting.php" method="post" enctype="multipart/form-data">
                  <table class="table m-0">
                    ...
                    <input type="date" class="form-control" placeholder="Date" name="date" id="validationDefault03" required>
                      ...
                      <td>
                     <div class="input-group mb-3">
                      <input type="number" class="form-control" placeholder="Insert revenue here.." name="revenue" id="validationDefault04" required>
                      <div class="input-group-append input-group-text">
