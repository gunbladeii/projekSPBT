...
<?php if (!empty($RID['state'])){?>
                <div class="table-responsive">
                  <table id="example1" class="table m-0">
                    ...
                    <tr>
                      <td><?php echo $a++;?></td>
                      <td><a data-toggle="modal" data-target="#updatePesananJudul" data-whatever="<?php echo $RID['id'];?>" class="nav-link"><span class="badge badge-info"><?php echo strtoupper($RID['judul']);?></span></a></td>
