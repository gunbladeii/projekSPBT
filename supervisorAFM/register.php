...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>iBerkat | SUPERVISOR PAGE</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="../adminAFM/dist/img/iberkat.jpeg" alt="altus Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">iBerkat | Registration Section</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <div class="register-logo">
    <a href="index.php"><img src="../adminAFM/iberkat.jpeg" style="width:15%"></a>
  </div>
